      ...
      >
        ...
        <div className="space-y-[2em] z-10">
          ...
          <p className="text-bluefooter text-[1.8em] w-[70%]">
            Kelola semua link Anda di satu tempat yang aman dan menguntungkan.
          </p>
        </div>
        ...
        >
          <Lock className="w-full h-full p-6" />
        </motion.div>
      ...
      >
        <div className="w-full max-w-[45em]">
          ...
          >
            ...
            <motion.div variants={itemVariants}>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  id="email"
                  name="email"
                  // Desain input clean dari page report-abuse
            ...
            {/* Input Password */}
            <motion.div variants={itemVariants}>
              <div className="flex justify-between items-center mb-[.8em]">
                <label
                  htmlFor="password"
                  className="text-shortblack font-medium text-[1.6em] block"
                >
                  Password
                </label>
                <Link
                  href="/forgot-password" // Asumsi
                  className="text-[1.4em] font-medium text-bluelight hover:underline"
                >
                  Lupa password?
                </Link>
              </div>
