      ...
      <div className="flex flex-col md:flex-row gap-4 text-[0.9em] font-figtree">
        ...
        <div ref={statusRef} className="relative min-w-[160px] z-20">
          <button
            ...
            className={clsx(
              ...
              statusFilter !== "all" && "border-bluelight bg-blue-50"
            )}
          >
            <span
              className={clsx(
            ...
            <ChevronDown
              className={clsx(
                ...
                statusFilter !== "all" ? "text-bluelight" : "text-gray-400"
              )}
            />
          </button>
          ...
          <AnimatePresence>
            {openDropdown === "status" && (
              <motion.div
                ...
                className="absolute top-full right-0 mt-2 p-2 w-48 bg-white rounded-xl shadow-lg border border-gray-100"
              >
        ...
        <div ref={roleRef} className="relative min-w-[180px] z-20">
          <button
            ...
            className={clsx(
              "flex items-center justify-between gap-2 w-full text-[1.6em] px-4 py-3 rounded-xl border border-gray-200 bg-white hover:bg-blues transition-all duration-200 font-medium",
              roleFilter !== "all" && "border-bluelight bg-blue-50"
            )}
          >
            <span
              className={clsx(
            ...
            <ChevronDown
              className={clsx(
                ...
                roleFilter !== "all" ? "text-bluelight" : "text-gray-400"
              )}
            />
          </button>
          ...
          <AnimatePresence>
            {openDropdown === "role" && (
              <motion.div
                ...
                exit={{ opacity: 0, y: 5 }}
                transition={{ duration: 0.15 }}
                className="absolute top-full right-0 mt-2 p-2 w-52 bg-white rounded-xl shadow-lg border border-gray-100"
              >
                {roleOptions.map((opt) => (
                  <button
                    key={opt.value}
