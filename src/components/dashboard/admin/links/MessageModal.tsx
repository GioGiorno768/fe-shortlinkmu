...
import { X, Send, AlertTriangle, Megaphone, Loader2 } from "lucide-react"; // Tambah Loader2
...
export default function MessageModal({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (message.trim()) {
      onSend(message, type);
      // Reset form kalau sukses (bisa di-handle parent juga sebenernya)
      // Tapi di sini kita reset pas modal close aja biasanya
    }
  };
                ...
                <div className="space-y-3">
                  ...
                  <div className="relative group">
                    <textarea
                      ...
                      placeholder={
                        type === "warning"
                          ? "Tulis alasan kenapa link ini bermasalah (misal: Melanggar TOS)..."
                          : "Tulis pesan atau pengumuman untuk pemilik link ini..."
                      }
                      className={clsx(
